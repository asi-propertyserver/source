			...
			<sec:authorize access="hasRole('ROLE_CONTRIBUTOR')">
				<div id="freebim_graph">
					<div id="graph_load_options">
						<div class="graph-load-option"><input type="button" value="zurücksetzen" i18n="BUTTON_RESET" class="graph-reset-btn"></div>
						<div class="graph-load-option"><input type="checkbox" name="RECURSIVE"><span i18n="RECURSIVE">rekursiv</span></div>
						<div class="graph-load-option"><input type="checkbox" name="CLAZZ_PARAMETER"><span i18n="CLAZZ_PARAMETER">Parameter</span></div>
						<div class="graph-load-option"><input type="checkbox" name="EQUALITY"><span i18n="EQUALITY">Gleichheit</span></div>
						<div class="graph-view-option"><small>CMD-click, SHIFT-hover, ALT-hover,<br>CTRL-click, ALT-click</small></div>
					</div>
					<div id="graph_view_options">
						<div class="graph-view-option"><input type="button" value="einfrieren" i18n="TOGGLE_GRAPH_FORCE" class="std-button graph-freeze-btn"></div>
						<div class="graph-view-option"><span i18n="TOGGLE_PARAMETER_VIEW">Parameter ein/aus</span><input type="checkbox" name="TOGGLE_PARAMETER_VIEW" checked></div>
						<div class="graph-view-option"><span i18n="TOGGLE_EQUAL_VIEW">Gleichheit ein/aus</span><input type="checkbox" name="TOGGLE_EQUAL_VIEW" checked></div>
						<div class="graph-view-option"><span i18n="TOGGLE_TEXT_VIEW">Text ein/aus</span><input type="checkbox" name="TOGGLE_TEXT_VIEW" checked></div>
						<div class="graph-view-option"><span i18n="TOGGLE_LIBRARY_VIEW">Bibliotheken einfärben</span><input type="checkbox" name="TOGGLE_LIBRARY_VIEW" checked></div>
					</div>
					<div id="graph"></div>
				</div>
				...
				<div id="freebim_problems">
					<div id="freebim_problems_acc">
						<h3 problem="1"><span i18n="H_COMP_NO_PARAMS">Komponenten ohne Parameter</span></h3>
						<div id="freebim_problems_no_params"></div>
						<h3 problem="2"><span i18n="H_PARAMS_WITH_NO_MEASURE">Parameter ohne Bemessung</span></h3>
						<div id="freebim_problems_no_measure"></div>
						<h3 problem="3"><span i18n="H_MEASURE_WITHOUT_VALUELIST">Bemessung ohne Werteliste und Datentyp</span></h3>
						<div id="freebim_problems_empty_measure"></div>
						<h3 problem="4"><span i18n="H_PARAMS_WITH_DELETED_PHASE">Parameter mit gelöschter Projektphase</span></h3>
						<div id="freebim_problems_deleted_phase"></div>
						<h3 problem="5"><span i18n="H_PARAMS_TO_MOVE_UP">Parameter zu Obergruppe verschieben</span></h3>
						<div id="freebim_problems_params_move_up"></div>
						<h3 problem="6"><span i18n="H_MULTIPLE_PARAMS">Parameter Mehrfachzuordnung</span></h3>
...
<%@ include file="imprint.jsp" %>		
	...
	<sec:authorize access="hasRole('ROLE_GUEST') || hasRole('ROLE_CONTRIBUTOR') || hasRole('ROLE_USERMANAGER') || hasRole('ROLE_ADMIN')">
	<div id="freebim-dlg2"></div>
	<div id="freebim-progress">
		<img alt="progress" src="/resources/ajax-progress.gif">
		<p id="freebim-progress-msg"><span i18n="DLG_IN_PROGRESS">in Bearbeitung ...</span></p>
	</div>
	</sec:authorize>	
	</div> <!-- center -->
