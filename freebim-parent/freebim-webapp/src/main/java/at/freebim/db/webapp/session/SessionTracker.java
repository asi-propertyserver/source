...
public interface SessionTracker {
	 ...
	 * 
	 * @param info the info that should be added to the {@link SessionObject}
	...
	/**
	 * Get all the session id of the session of a user that 
	 * has the specified user name.
	 * 
	...
	/**
	 * Get the time stamp of the last request from 
	 * the session that has the provided session id. 
	 * 
	 * @param sessionId the id of the session
