...
import at.freebim.db.json.NodeFields;
import at.freebim.db.json.rel.RelationFields;
...
public class JsCreator {
	 ...
	 * @param tried 0 if the project is build and 1 if the project is build from the
	 *              parent project
	 * @throws IOException this exception is thrown when there is a problem writing
	 *                     to a file
	 */
	 ...
	 * the type of relations ({@link RelationTypeEnum}) with the corresponding ui
	 * names. Everything is written as javascript.
	 * 
	 * @param filename the name of the file that will be created
	 * @throws IOException the exception that is thrown when there is a problem with
	...
	/**
	 * Creates a file with the passed filename. In that file a header is written and
	 * the {@link State}s with the corresponding css classes. Everything is written
	 * as javascript.
	 * 
	 * @param filename the name of the file that will be created
	 * @throws IOException the exception that is thrown when there is a problem with
	...
	/**
	 * Creates a file with the passed filename. In that file a header and the
	 * {@link NodeFields}, {@link RelationFields}, {@link ContributionType}s,
	 * {@link ComponentType}s are written. Everything is written as javascript.
	 * 
	 * @param filename the name of the file that will be created
	 * @throws IOException the exception that is thrown when there is a problem with
	 *                     creating or writing to a file
