...
/**
 * This controller can be used to search for things in the database. It extends
...
public class SearchController extends BaseAuthController {
	 ...
	 * a type after what you search. A type is for example, the type ({@link Named},
	 * {@link Coded}, {@link Described}, ...) of nodes, you have to query over to
	 * match the search string against.
	 * 
	 * @param searchstring the string after that you want to search. This parameter
	 *                     is required
	 * @param searchtype   the type after what you want to search. This parameter is
	 *                     required
	 * @return the {@link AjaxResponse} that includes the node that has been found
	 *         or the error message
	 */
	@GetMapping(value = "/search")
	public @ResponseBody AjaxResponse search(@RequestParam(value = "searchstring", required = true) String searchstring,
	...
	/**
	 * Make a search using n-grams. You have to specify a string after what you want
	 * to search and a class name (class that extends {@link Ngramed}).
	 * 
	 * @param searchstring the string after what you search. This parameter is
	 *                     required
	 * @param clazzName    the name of the class. Must extend {@link Ngramed}. This
	 *                     parameter is required
	 * @return the {@link AjaxResponse} that includes the found list a ngram nodes
	 *         or the erro message
	 */
	@GetMapping(value = "/find")
	public @ResponseBody AjaxResponse find(@RequestParam(value = "searchstring", required = true) String searchstring,
