...
/**
 * This class represents a json-serializer for the class/relation {@link ContributedBy}.
...
public class ContributedBySerializer extends TimestampedBaseRelSerializer<ContributedBy> {
	...
	public void serialize(final ContributedBy v, final JsonGenerator g, final SerializerProvider p)
		...
		g.writeNumberField(RelationFields.CONTRIBUTION_TYPE.getSerial(), ((v.getContributionType() != null) ? v.getContributionType().getCode() : ContributionType.UNDEFINED.getCode()));
