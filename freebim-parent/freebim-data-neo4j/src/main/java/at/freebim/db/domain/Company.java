...
import at.freebim.db.domain.json.CompanyDeserializer;
import at.freebim.db.domain.json.CompanySerializer;
...
/**
 *
 * This node represents a company.
...
public class Company extends LifetimeBaseNode implements Coded, Named, Orderable {
	 ...
	 */
	@RelatedToVia(type=RelationType.WORKS_FOR, direction=Direction.INCOMING)
	@Fetch
	 ...
	 */
	@RelatedToVia(type=RelationType.COMPANY_COMPANY, direction=Direction.BOTH)
	@Fetch
