...
public interface EqualityService {
	...
	/**
	 * Test whether the passed object equals the object that is referenced by
	 ...
	 * @param obj
	 *            The object.
	 * @return <code>true</code> whenever both objects are equal (have the same
	 *         node ID).
	 */
	public <T extends NodeIdentifyable, R extends BaseRel<?, T>> boolean relatedEquals(
			final Iterable<R> iterable, final T obj);

	/**
	 * Test whether the passed object list equals the objects that are
	 * referenced by the passed relationship.
	 * 
	 * @param <T> Type of entity
	 * @param <R> Type of relationship
	 * @param iterable
