 ...
 * {@link MessageNode}. It extends {@link LifetimeBaseNodeSerializer}.
 *
...
public class MessageNodeSerializer extends LifetimeBaseNodeSerializer<MessageNode> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -845480145578106735L;
	...
	/**
	 * The json-serializer for the relations from {@link MessageNode} to
	 * {@link FreebimUser}. It denotes if a message has been seen by the user.
	 */
	...
	@Override
	public void serialize(final MessageNode v, final JsonGenerator g, final SerializerProvider p)
		...
		if (v.getShowFrom() != null)
			g.writeStringField(NodeFields.SHOW_FROM.getSerial(),
					String.valueOf(v.getShowFrom() - DateService.FREEBIM_DELTA));
		if (v.getShowUntil() != null)
			g.writeStringField(NodeFields.SHOW_UNTIL.getSerial(),
					String.valueOf(v.getShowUntil() - DateService.FREEBIM_DELTA));
