...
/**
 * Repository for the node/class {@link FreebimUser}. It extends
 ...
 */
public interface FreebimUserRepository extends Neo4jRepository<FreebimUser, Long> {
	 ...
	 */
	FreebimUser findByUsername(String login);
}
