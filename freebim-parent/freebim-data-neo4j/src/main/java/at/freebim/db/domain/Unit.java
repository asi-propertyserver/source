...
import at.freebim.db.json.UnitDeserializer;
import at.freebim.db.json.UnitSerializer;
import net.spectroom.neo4j.backup.annotation.NodeBackup;

/**
 * The node for a unit. It extends {@link ContributedBaseNode} and implements
 * {@link Described} {@link Named} and {@link BsddObject}.
 *
