...
public interface BsddObjectService<T extends BsddObject> {
	...
	/**
	 * Find all nodes <b>T</b> that extend {@link BsddObject} that have the provided bsdd-guid.
	 * 
	 * @param bsddGuid the bsdd-guid
	 * 
	 * @return returns a {@link List} of nodes <b>T</b> that have the corresponding bsdd-guid
	 * */
	public List<T> findByBsddGuid(String bsddGuid);
}
