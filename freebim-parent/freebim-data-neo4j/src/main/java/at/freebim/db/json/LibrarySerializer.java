...
public class LibrarySerializer extends HierarchicalBaseNodeSerializer<Library> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 862201257535497808L;
	/**
	 * The json-serializer for the relations from a {@link Contributor} to a
	 * {@link Library}. This denotes that the {@link Contributor} is responsible for
	 * the {@link Library}.
	 */
