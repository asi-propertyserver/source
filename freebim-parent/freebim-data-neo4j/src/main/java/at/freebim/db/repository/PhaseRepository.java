...
/**
 * The repository for the node/class {@link Phase}. It extends
 ...
 */
public interface PhaseRepository extends Neo4jRepository<Phase, Long> {
	...
	List<Phase> findByBsddGuid(String bsddGuid);
