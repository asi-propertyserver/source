...
import at.freebim.db.json.rel.HasParameterSetDeserializer;
import at.freebim.db.json.rel.HasParameterSetSerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between the nodes or classes
 * {@link HierarchicalBaseNode} and {@link ParameterSet}. It denotes the owner
 * ({@link HierarchicalBaseNode}) of a {@link ParameterSet}. This relation
 * extends {@link BaseRel}.
 *
