...
import at.freebim.db.domain.json.rel.ParentOfDeserializer;
import at.freebim.db.domain.json.rel.ParentOfSerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between nodes or classes {@link HierarchicalBaseNode}.
 * It denotes that one node is parent of another node. This creates a hierarchy.
 * This relation extends {@link OrderedBaseRel} and 
