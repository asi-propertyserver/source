...
/**
 * This is the service for the node/class {@link SimpleNamedNode}. This service
 * extends {@link HierarchicalBaseNodeServiceImpl} and implements
 * {@link SimpleNamedNodeService}.
 *
 ...
 */
@Service
public class SimpleNamedNodeServiceImpl extends HierarchicalBaseNodeServiceImpl<SimpleNamedNode>
		implements SimpleNamedNodeService {
	...
	@Override
	@Autowired
	public void setRepository(Neo4jRepository<SimpleNamedNode, Long> r) {
		this.repository = r;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see at.freebim.db.service.SimpleNamedNodeService#find(java.lang.String,
	 * java.lang.String)
	 */
	@Override
	@Transactional(readOnly = true)
	public SimpleNamedNode find(String name, String type) {
		SimpleNamedNode node;
		if (type == null)
	 ...
	 * (non-Javadoc)
	 * 
	 * @see at.freebim.db.service.SimpleNamedNodeService#get(java.lang.String,
	 * java.lang.String)
	 */
	@Override
	@Transactional
