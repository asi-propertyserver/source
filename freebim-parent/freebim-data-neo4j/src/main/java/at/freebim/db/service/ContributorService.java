...
/**
 * The service for the class {@link Contributor}. The service extends
...
public interface ContributorService extends LifetimeBaseNodeService<Contributor> {
	...
	String FREEBIM_CONTRIBUTOR_CODE = "freeBIM-App";
	...
	/**
	 * Checks if the {@link Contributor} has all the roles that are provided in the
	 * second parameter <b>roleContributors</b>.
	 *
	 * @param contributor      the {@link Contributor}
	 * @param roleContributors an array of roles
	 * @return <code>true</code> if the {@link Contributor} has every role,
	 *         <code>false</code> otherwise
	 */
	boolean test(Contributor contributor, RoleContributor[] roleContributors);
}
