...
public interface AdminService {
	...
	/**
	 * Creates a backup. If the directory, in which the backup will be saved, does
	 * not exist then it will be created.
	 *
	 * @return returns <code>true</code> if the backup succeeds and
	...
	/**
	 * Get a list of all available backups, previously created via
	 * {@link #createBackup()}.
	 *
	 ...
	 *               Possible backup names could be retrieved via
	 *               {@link #getAvailableBackups()}.
