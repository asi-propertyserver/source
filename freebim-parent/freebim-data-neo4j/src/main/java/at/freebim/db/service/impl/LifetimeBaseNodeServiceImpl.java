 ...
 * define functionality for a class <b>T</b> that extends {@link LifetimeBaseNode}.
 * This service extends {@link BaseNodeServiceImpl} and implements {@link LifetimeBaseNodeService}.
 * 
 ...
 */
@Service
public class LifetimeBaseNodeServiceImpl<T extends LifetimeBaseNode> extends BaseNodeServiceImpl<T> implements
		LifetimeBaseNodeService<T> {
	 ...
	 */
	@Override
	public void setRepository(GraphRepository<T> r) {
		this.repository = r;
	}

	/* (non-Javadoc)
	 * @see at.freebim.db.service.impl.AbstractService#delete(at.freebim.db.domain.base.BaseNode)
	 */
	@Override
	@Transactional
