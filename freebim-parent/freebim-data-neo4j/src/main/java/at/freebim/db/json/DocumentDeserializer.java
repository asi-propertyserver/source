 ...
 * {@link Document}. It extends {@link UuidentifyableDeserializer}.
 *
...
public class DocumentDeserializer extends UuidentifyableDeserializer<Document> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2008683723882327754L;

	@Override
	public Document deserialize(JsonParser p, DeserializationContext c) throws IOException, JsonProcessingException {
