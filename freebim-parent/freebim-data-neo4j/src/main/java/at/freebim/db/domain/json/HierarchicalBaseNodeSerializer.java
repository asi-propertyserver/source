 ...
 * The class itself extends {@link ParameterizedSerializer}.
 * 
...
public class HierarchicalBaseNodeSerializer<T extends HierarchicalBaseNode> extends ParameterizedSerializer<T> {
	...
	/**
	 * The json-serializer for the relation to the parents of a {@link HierarchicalBaseNode}.
	 */
	private final IterableSerializer<ParentOf> parentRelationSerializer;
	
	
	/**
	 * The json-serializer for the relation to the child's of a {@link HierarchicalBaseNode}.
	 */
	private final IterableSerializer<ParentOf> childsRelationSerializer;
	
	/**
	 * The json-serializer for the relation from a {@link HierarchicalBaseNode} to a {@link ParameterSet}.
	 */
	...
	/* (non-Javadoc)
	 * @see at.freebim.db.domain.json.ParameterizedSerializer#serialize(at.freebim.db.domain.base.Parameterized, org.codehaus.jackson.JsonGenerator, org.codehaus.jackson.map.SerializerProvider)
	 */
	@Override
