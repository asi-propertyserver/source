 ...
 * This service extends {@link StatedBaseNodeServiceImpl} and implements {@link ParameterService}.
 * 
...
public class ParameterServiceImpl extends StatedBaseNodeServiceImpl<Parameter> implements ParameterService {
	...
	@Override
	@Autowired
	public void setRepository(GraphRepository<Parameter> r) {
		this.repository = r;
	}
	...
	/* (non-Javadoc)
	 * @see at.freebim.db.service.ParameterService#getByNameFromLibrary(java.lang.String, java.lang.Long)
	 */
	@Override
