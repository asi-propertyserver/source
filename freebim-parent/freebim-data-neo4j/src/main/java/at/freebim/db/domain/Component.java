...
import at.freebim.db.domain.json.ComponentDeserializer;
import at.freebim.db.domain.json.ComponentSerializer;
...
/**
 * This node represents a component.
 * It extends {@link HierarchicalBaseNode} and
 * implements {@link Orderable}, {@link Named}, {@link Coded}, {@link Described} and {@link BsddObject}.
 * 
...
public class Component extends HierarchicalBaseNode implements Orderable, Named, Coded, Described, BsddObject {
	...
	/**
	 * The relation to the materials ({@link Component}s) the {@link Component} is build of.
	 * 
	...
	/**
	 * The relation to the {@link Parameter}s that will be overriden.
	 */
	 ...
	 */
	@RelatedToVia(type = RelationType.HAS_PARAMETER, direction=Direction.OUTGOING)
	@Fetch	
	 ...
	 * 
	 * @return the relation to materials ({@link Component}) that the {@link Component} is made of
	 */
	@RelatedToVia(type = RelationType.OF_MATERIAL, direction=Direction.OUTGOING)
	@Fetch
	...
	/**
	 * Get the relations to the different parts of which a {@link Component} is composed.
	 * 
	 * @return the parts
	 */
	@RelatedToVia(type = RelationType.COMP_COMP, direction=Direction.OUTGOING)
	@Fetch
	 ...
	 */
	@RelatedToVia(type = RelationType.VALUE_OVERRIDE, direction=Direction.OUTGOING)
	@Fetch
	 ...
	 * 
	 * @return <code>true</code> if path to this Component leads to <code>IfcMaterialDefinition</code>
	 */
	@Transient
	public boolean isM() {
		return m;
