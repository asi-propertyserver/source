 ...
 * {@link Contributor}. It extends {@link LifetimeBaseNodeSerializer}.
 *
...
public class ContributorSerializer extends LifetimeBaseNodeSerializer<Contributor> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4233820439217687509L;
	...
	/**
	 * The json-serializer for the relations to the list of companies
	 * ({@link Company}) that the {@link Contributor} is working for.
	 */
	private final IterableSerializer<WorksFor> companySerializer;

	/**
	 * The json-serializer for the relations to the list of libraries
	 * ({@link Library}) the the {@link Contributor} is responsible for.
	 */
	...
	@Override
	public void serialize(final Contributor v, final JsonGenerator g, final SerializerProvider p)
