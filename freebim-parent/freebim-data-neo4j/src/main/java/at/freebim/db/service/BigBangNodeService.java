...
/**
 * The service for the class/node {@link BigBangNode}. It extends
...
public interface BigBangNodeService extends HierarchicalBaseNodeService<BigBangNode> {
	...
	/**
	 * Get the root node/class ({@link BigBangNode}. If there exists no
	 * {@link BigBangNode} one is created.
	 *
	 * @return returns the root node/class {@link BigBangNode}.
	 */
	BigBangNode getBigBangNode();
}
