...
import at.freebim.db.domain.json.rel.ComponentComponentDeserializer;
import at.freebim.db.domain.json.rel.ComponentComponentSerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between two nodes or classes {@link Component}.
 * A {@link Component} can be part of other {@link Component}s.
