...
import at.freebim.db.domain.json.MeasureDeserializer;
import at.freebim.db.domain.json.MeasureSerializer;
...
/**
 * This node represents a measurement.
 * It extends {@link ContributedBaseNode} and 
 * implements {@link Named}, {@link Orderable} and {@link BsddObject}.
 * 
...
public class Measure  extends ContributedBaseNode implements Named, Orderable, BsddObject {
	 ...
	 */
	@RelatedToVia(type = RelationType.OF_DATATYPE, direction=Direction.OUTGOING)
	@Fetch
	 ...
	 */
	@RelatedToVia(type = RelationType.OF_UNIT, direction=Direction.OUTGOING)
	@Fetch
	 ...
	 */
	@RelatedToVia(type = RelationType.HAS_VALUE, direction=Direction.OUTGOING)
	@Fetch
	 ...
	 */
	@RelatedToVia(type=RelationType.HAS_MEASURE, direction=Direction.INCOMING)
	@Fetch
	...
	/* (non-Javadoc)
	 * @see at.freebim.db.domain.base.ContributedBaseNode#equalsData(java.lang.Object)
	 */
	@Override
