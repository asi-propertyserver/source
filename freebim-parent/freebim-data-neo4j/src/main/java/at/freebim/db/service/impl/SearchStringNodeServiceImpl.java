 ...
 * This class extends {@link BaseNodeServiceImpl} and 
 * implements {@link SearchStringNodeService}.
 * 
 ...
 */
@Service
public class SearchStringNodeServiceImpl extends BaseNodeServiceImpl<SearchStringNode> implements SearchStringNodeService {
	...
	@Override
	@Autowired
	public void setRepository(GraphRepository<SearchStringNode> r) {
		this.repository = r;
	}
