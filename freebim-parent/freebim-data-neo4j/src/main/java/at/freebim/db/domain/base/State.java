...
public enum State {
	...
	UNDEFINED(1, "STATE_UNDEFINED", "state-undefined"), REJECTED(2, "STATE_REJECTED", "state-rejected"),
	TODELETE(5, "STATE_TODELETE", "state-rejected"), CHECKED(3, "STATE_CHECKED", "state-checked"),
	RELEASED(4, "STATE_RELEASED", "state-released"), IMPORTED(6, "STATE_IMPORTED", "state-imported");
	 ...
	 */
	State(int code, String uiName, String cssClass) {
		this.code = code;
		this.uiName = uiName;
