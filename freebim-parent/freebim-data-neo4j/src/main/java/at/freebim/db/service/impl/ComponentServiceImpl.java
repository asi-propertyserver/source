...
/**
 * The service for the node/class {@link Component}.
 * This service extends {@link HierarchicalBaseNodeServiceImpl} and implements
...
public class ComponentServiceImpl extends HierarchicalBaseNodeServiceImpl<Component> implements ComponentService {
	...
	@Override
	@Autowired
	public void setRepository(GraphRepository<Component> r) {
		this.repository = r;
	}
	...
	/* (non-Javadoc)
	 * @see at.freebim.db.service.ComponentService#getByNameFromLibrary(java.lang.String, java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see at.freebim.db.service.ComponentService#getEqualFromLibrary(java.lang.Long, java.lang.Long)
	 */
	@Override
	public Component getEqualFromLibrary(Long srcNodeId, Long libraryNodeId) {
		...
		while (iter.hasNext()) {
			...
			if (pathNode != null && pathNode instanceof Component) {
				co = (Component) pathNode;
	...
	/* (non-Javadoc)
	 * @see at.freebim.db.service.ComponentService#getNodesFromHierarchy(java.lang.String)
	 */
	@Override
	@Transactional(readOnly=true)
	public List<Component> getNodesFromHierarchy(String rootName) {
		...
		b.append(" AND ALL (y in nodes(path) WHERE y.validFrom <= {now} AND (y.validTo IS NULL OR y.validTo >= {now}))");
		b.append(" RETURN co");
