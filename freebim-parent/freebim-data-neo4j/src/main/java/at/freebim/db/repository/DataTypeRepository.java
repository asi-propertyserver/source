...
/**
 * Repository for the node/class {@link DataType}. It extends
 ...
 */
public interface DataTypeRepository extends Neo4jRepository<DataType, Long> {
	...
	List<DataType> findByBsddGuid(String bsddGuid);
