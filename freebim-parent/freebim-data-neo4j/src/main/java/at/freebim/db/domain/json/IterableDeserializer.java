...
/**
 * This class represents a json-deserializer for a class <b>T</b> .
 * This class can deserialize a list of elements of the type <b>T</b>.
 * 
...
public class IterableDeserializer<T> {
	...
	/**
	 * This method takes a json-object and returns a list of class-objects of the type @T that have been deserialized.
	 * 
	 * @param node the json-object
	 * @param c the context
	 * 
	 * @see org.codehaus.jackson.JsonNode
	...
	public ArrayList<T> deserialize(JsonNode node, DeserializationContext c)
	    ...
	    if (node != null && node.isArray()) {
	    	Iterator<JsonNode> elems = node.getElements();
