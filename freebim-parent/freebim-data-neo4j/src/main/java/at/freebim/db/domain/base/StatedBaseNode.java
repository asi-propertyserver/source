...
/**
 * This abstract class/node is the base for all nodes that need to define a state.
 * It extends {@link ContributedBaseNode}.
 * 
...
public abstract class StatedBaseNode extends ContributedBaseNode {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((statusComment == null) ? 0 : statusComment.hashCode());
		return result;
	}
