...
import at.freebim.db.domain.json.rel.MessageClosedDeserializer;
import at.freebim.db.domain.json.rel.MessageClosedSerializer;

/**
 * The node to node relation between the nodes or classes {@link MessageNode} and {@link FreebimUser}.
 * It denotes that a message ({@link MessageNode}) has been closed by a user ({@link FreebimUser}).
