...
import at.freebim.db.json.rel.EqualsDeserializer;
import at.freebim.db.json.rel.EqualsSerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between two nodes or classes {@link BaseNode}. It
 * denotes if two nodes {@link BaseNode} are equals. This relation extends
 * {@link QualifiedBaseRel}.
 *
