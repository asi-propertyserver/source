...
/**
 * The service for the node/class {@link FreebimUser}. This service extends
...
public interface FreebimUserService extends LifetimeBaseNodeService<FreebimUser> {
	 ...
	 */
	FreebimUser get(String login);

	/**
	 * Registers a new {@link FreebimUser}. Throws an
	 * {@link UsernameExistsException} when the username already exists in the
	 * database.
	 *
	 * @param login       the username
	 * @param password    the password. Can also be already hashed
	 * @param roles       the roles the user should have
	 * @param contributor the {@link Contributor} the {@link FreebimUser} should
	 *                    have
	 * @return the persisted and saved {@link FreebimUser}.
	 * @throws UsernameExistsException will be thrown when the username already
	 *                                 exists in the database
	 */
	@Secured({ "ROLE_USERMANAGER" })
	FreebimUser register(String login, String password, Role[] roles, Contributor contributor)
	 ...
	 */
	boolean test(String login, String password, Role[] roles);
}