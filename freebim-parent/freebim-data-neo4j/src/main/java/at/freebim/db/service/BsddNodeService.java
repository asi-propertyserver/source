...
/**
 * The service of the node/class {@link BsddNode}.
 * It extends {@link BaseNodeService}.
 * 
...
public interface BsddNodeService extends BaseNodeService<BsddNode> {
	...
	/**
	 * Create BSDD relations for nodes that
	 * have an EQUAL relation to other nodes (all at once).
	 * 
