 ...
 * {@link ParentOf}. It extends {@link OrderedBaseRelSerializer}.
 *
 * @author rainer.breuss@uibk.ac.at
 * @see at.freebim.db.domain.rel.ParentOf
 * @see OrderedBaseRelSerializer
 */
public class ParentOfSerializer extends OrderedBaseRelSerializer<ParentOf> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5635703613163857408L;

	@Override
	public void serialize(final ParentOf v, final JsonGenerator g, final SerializerProvider p)
