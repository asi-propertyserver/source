...
/**
 * The repository for the node/class {@link ParameterSet}.
 ...
 *
 */
public interface ParameterSetRepository extends GraphRepository<ParameterSet> {

	/**
	 * Get a list of {@link ParameterSet}s that are connected to a node that has the provided id.
	 * 
	...
	public Iterable<ParameterSet> getFor(Long nodeId);
