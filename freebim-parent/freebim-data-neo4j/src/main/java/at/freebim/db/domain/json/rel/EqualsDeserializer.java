...
/**
 * This class represents a json-deserializer for the class/relation {@link Equals}.
...
public class EqualsDeserializer extends QualifiedBaseRelDeserializer<Equals> {
	 ...
	 */
	@Override
	public Equals deserialize(JsonParser p, DeserializationContext ctxt)
        ...
        if (invalidNode != null) {
        	if (invalidNode.getNumberValue().intValue() == 1)
        		v.setValid(false);
        }
        ...
        if (crossClassNode != null) {
        	String ccc = crossClassNode.getTextValue();
