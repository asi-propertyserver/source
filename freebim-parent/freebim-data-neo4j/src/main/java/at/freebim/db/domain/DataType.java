...
import at.freebim.db.domain.json.DataTypeDeserializer;
import at.freebim.db.domain.json.DataTypeSerializer;
...
public class DataType extends ContributedBaseNode implements Named, Described, BsddObject {
	 ...
	 */
	@RelatedToVia(type = RelationType.OF_DATATYPE, direction=Direction.INCOMING)
	@Fetch
