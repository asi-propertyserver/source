...
import at.freebim.db.domain.json.ContributorDeserializer;
import at.freebim.db.domain.json.ContributorSerializer;
...
/**
 *
 * This node represents a contributor.
...
public class Contributor extends LifetimeBaseNode implements Coded, Named, Timestampable {
	...
	/**
	 * The relation to which {@link Company} or companies the {@link Contributor} works for.
	 */
	...
	/**
	 * The relation for which {@link Library} the {@link Contributor} is responsible.
	 */
	...
	/**
	 * Gets the relations to the libraries ({@link Library}) the {@link Contributor} is responsible for.
	 * 
	 * @return the relation to libraries the {@link Contributor} is responsible for.
	 */
	@RelatedToVia(type=RelationType.RESPONSIBLE, direction=Direction.OUTGOING)
	@Fetch
	...
	/**
	 * Gets the relations to the companies ({@link Company}) the {@link Contributor} is working for
	 * 
	 * @return the relation to companies the {@link Contributor} is working for.
	 */
	@RelatedToVia(type=RelationType.WORKS_FOR, direction=Direction.OUTGOING)
	@Fetch
