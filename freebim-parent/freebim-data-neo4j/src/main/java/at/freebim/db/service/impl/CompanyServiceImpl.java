...
/**
 * The service for the node/class {@link Company}.
 * It extends {@link LifetimeBaseNodeServiceImpl} and 
 * implements {@link CompanyService}.
 * 
...
public class CompanyServiceImpl extends LifetimeBaseNodeServiceImpl<Company> implements CompanyService {
	...
	@Override
	@Autowired
	public void setRepository(GraphRepository<Company> r) {
		this.repository = r;
	}
