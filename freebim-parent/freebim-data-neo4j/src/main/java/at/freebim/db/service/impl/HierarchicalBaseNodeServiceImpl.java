 ...
 * for a class <b>T</b> that extends {@link HierarchicalBaseNode}. This service
 * extends {@link ParameterizedServiceImpl} and implements
...
public abstract class HierarchicalBaseNodeServiceImpl<T extends HierarchicalBaseNode>
		extends ParameterizedServiceImpl<T> implements HierarchicalBaseNodeService<T> {
