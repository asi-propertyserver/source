...
/**
 * This class represents a json-serializer for a class <b>T</b> . This class can
 * serialize a list of elements of the type <b>T</b>.
 *
...
public class IterableSerializer<T> {
	...
	/**
	 * Creates a new instance with the name of the json-field in which the
	 * {@link Iterable} will be serialized.
	 *
	...
	/**
	 * This method takes a @Iterable of classes of the type @T and creates an array
	 * of json-objects
	 *
	 ...
	 */
	public void serialize(final Iterable<T> v, final JsonGenerator g, final SerializerProvider p)
			throws IOException, JsonProcessingException {

		logger.debug("serializing field '{}' of type '{}' ...", this.fieldName,
