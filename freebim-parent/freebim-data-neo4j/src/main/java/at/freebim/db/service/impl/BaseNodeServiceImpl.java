 ...
 * for a class <b>T</b> that extends {@link BaseNode}. This service extends
 * {@link AbstractService} and implements {@link BaseNodeService}.
 *
...
public abstract class BaseNodeServiceImpl<T extends BaseNode> extends AbstractService<T> implements BaseNodeService<T> {
	...
	public ArrayList<T> getAll(boolean onlyRelevant) {
		if (!onlyRelevant) {
			...
			logger.debug("getAll: got {} objects for service {}", ((all == null) ? "null" : all.size()),
					this.getClass());
	 ...
	 * 
	 * @see
	 * at.freebim.db.service.impl.AbstractService#save(at.freebim.db.domain.base.
	 * BaseNode)
	 */
	@Override
	@Transactional
	public T save(T node) {
		logger.debug("save: {} nodeId={} ...", node == null ? "?" : node.getClass().getSimpleName(),
		...
		if (node.getNodeId() != null) {
			...
			saved = this.repository.findById(node.getNodeId()).orElse(null);
...
//			throw e;
	 ...
	 * 
	 * @see
	 * at.freebim.db.service.BaseNodeService#filterResponse(at.freebim.db.domain.
	 * base.BaseNode)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * at.freebim.db.service.BaseNodeService#filterBeforeSave(at.freebim.db.domain.
	 * base.BaseNode)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * at.freebim.db.service.BaseNodeService#filterAfterSave(at.freebim.db.domain.
	 * base.BaseNode)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * at.freebim.db.service.BaseNodeService#filterBeforeInsert(at.freebim.db.domain
	 * .base.BaseNode)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * at.freebim.db.service.BaseNodeService#filterAfterInsert(at.freebim.db.domain.
	 * base.BaseNode)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * at.freebim.db.service.BaseNodeService#filterBeforeDelete(at.freebim.db.domain
	 * .base.BaseNode)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * at.freebim.db.service.BaseNodeService#filterAfterDelete(at.freebim.db.domain.
	 * base.BaseNode)
	 */
	@Override
	...
	public T deleteByNodeId(Long nodeId) {
		if (nodeId != null) {
			T node = this.repository.findById(nodeId).orElse(null);
			if (node != null) {
				try {
	...
	public ArrayList<T> getAllRelevant() {
		...
		getRelevantQuery(b, " RETURN DISTINCT ID(y) AS n");
		...
		while (iter.hasNext()) {
			...
			BaseNode node = this.getByNodeId(n);

			if (node != null) {
				res.add((T) node);
			}

			logger.debug("    found node {} ", n);
		}
