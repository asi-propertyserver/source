...
public interface ProblemService {
	...
	/**
	 * Represents a triple of node with id and name.
	 * This class extends {@link IdPair}.
	 * 
	 ...
	 *
	 */
	public class IdTriple extends IdPair {
	...
	/**
	 * Get all nodeId's of Components without any Parameters on their path to BigBangNode.
	 * 
	 * @return the {@link ArrayList} of nodeId's
	 */
	...
	/**
	 * Get all nodeId's of Parameters referenced by a HasParameter relations 
	...
	/**
	 * Get all ID's of parameters that are assigned multiple times along a single path.
	 * 
	 * @return An <code>IdTriple</code> that contains the first Component in a, the 2nd Component in b and the Parameter in c.
	 */
