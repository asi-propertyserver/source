 ...
 * define functionality for a class <b>T</b> that extends {@link Parameterized}.
 * This service extends {@link StatedBaseNodeServiceImpl} and implements {@link ParameterizedService}.
 * 
 ...
 *
 */
public abstract class ParameterizedServiceImpl<T extends Parameterized>
		extends StatedBaseNodeServiceImpl<T> implements
		ParameterizedService<T> {
