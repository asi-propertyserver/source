...
public class MeasureDeserializer extends ContributedBaseNodeDeserializer<Measure> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3384976924817262838L;
	...
	@Override
	public Measure deserialize(JsonParser p, DeserializationContext c) throws IOException, JsonProcessingException {
