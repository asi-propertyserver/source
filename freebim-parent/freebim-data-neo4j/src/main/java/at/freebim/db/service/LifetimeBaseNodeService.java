...
/**
 * The service for a node/class <b>T</b> that extends {@link LifetimeBaseNode}.
 ...
 *
 */
public interface LifetimeBaseNodeService<T extends LifetimeBaseNode> extends BaseNodeService<T> {
}
