...
/**
 * This enum list the name of the fields.
 * These names are used when serializing to json.
 * 
...
public enum NodeFields {
	...
	MEASURES			("me"),		 	// HasMeasure relations; HasValue relations; Measure in OfDataType relations; Measure in OfUnit relations
	NAME				("n"),			// name field
