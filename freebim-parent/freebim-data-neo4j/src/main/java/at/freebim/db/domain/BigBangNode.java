...
import at.freebim.db.json.BigBangNodeDeserializer;
import at.freebim.db.json.BigBangNodeSerializer;
 ...
 * calculated to this node. This nodes extends {@link HierarchicalBaseNode}.
 *
...
public class BigBangNode extends HierarchicalBaseNode {
	 ...
	 * 
	 * @see
	 * at.freebim.db.domain.base.HierarchicalBaseNode#equalsData(java.lang.Object)
	 */
	@Override
