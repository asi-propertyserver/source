...
public interface NgramService {
	 ...
	 * 
	 * @param active pass <code>true</code> if the service should be active <code>false</code> otherwise
	 */
	 ...
	 * @param clazz the class of n-gram relations ({@link Coded}, {@link Named}, {@link Described}
	 * @param toClass the class of destination nodes
	 * @return the {@link List} of matching nodes with there quality ({@link MatchResult})
	 */
	public List<MatchResult> find(String s, Class<? extends Ngramed> clazz, Class<?> toClass); 
	 ...
	 * @return a {@link Set} of {@link NgramNode}s that have been created from the provided {@link String}
	 */
	public Set<NgramNode> forString(String s);
	...
	/**
	 * Get matching node c. (fromNode)<-[fromNgramed]-()-[toNgramed]->(c).
	 * The quality of the relations should be greater than the provided value.
	 * 
	 ...
	 */
	public List<MatchResult> getMatch(Long fromNodeId, Class<? extends Ngramed> fromNgramed, Class<? extends Ngramed> toNgramed, Class<?> toClass, double minQuality);
