 ...
 * {@link OfUnit}. It extends {@link BaseRelDeserializer}.
 *
 * @author rainer.breuss@uibk.ac.at
 * @see at.freebim.db.domain.rel.OfUnit
 * @see BaseRelDeserializer
 */
public class OfUnitDeserializer extends BaseRelDeserializer<OfUnit> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1754199218953206426L;

	@Override
	public OfUnit deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JsonProcessingException {
