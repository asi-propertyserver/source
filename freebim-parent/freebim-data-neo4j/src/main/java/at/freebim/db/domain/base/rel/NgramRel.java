...
/**
 * Abstract base class for all relations concerning NGRAM. It extends
 * {@link QualifiedBaseRel}.
 *
 * @param <TO> Type that represents the end node of the relation. Start node of
 *             the relation will always be a NgramNode.
