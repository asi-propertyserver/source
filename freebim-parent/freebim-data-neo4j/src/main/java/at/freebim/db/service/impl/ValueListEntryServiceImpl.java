...
/**
 * The service for the node/class {@link ValueListEntry}. This service extends
 * {@link StatedBaseNodeServiceImpl} and implements
 * {@link ValueListEntryService}.
 *
 ...
 */
@Service
public class ValueListEntryServiceImpl extends StatedBaseNodeServiceImpl<ValueListEntry>
		implements ValueListEntryService {
	...
	@Override
	@Autowired
	public void setRepository(Neo4jRepository<ValueListEntry, Long> r) {
		this.repository = r;
	}
	 ...
	 * 
	 * @see
	 * at.freebim.db.service.impl.ContributedBaseNodeServiceImpl#filterRequest(at.
	 * freebim.db.domain.base.ContributedBaseNode)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * at.freebim.db.service.ValueListEntryService#correctNumberFormat(at.freebim.db
	 * .domain.ValueListEntry)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * at.freebim.db.service.impl.UuidIdentifyableServiceImpl#filterBeforeInsert(at.
	 * freebim.db.domain.base.UuidIdentifyable)
	 */
	@Override
