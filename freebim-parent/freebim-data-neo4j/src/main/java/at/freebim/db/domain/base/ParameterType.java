...
public enum ParameterType {
	...
	public static final ParameterType fromCode(int code) {
		switch (code) {
			case 1: return ParameterType.TYPE;
			case 2: return ParameterType.INSTANCE;
			case 3: return ParameterType.DERIVED;
			case 4: return ParameterType.IFC_ATTRIBUTE;
			case 5: return ParameterType.IFC_OPTIONAL_ATTRIBUTE;
			default: 
