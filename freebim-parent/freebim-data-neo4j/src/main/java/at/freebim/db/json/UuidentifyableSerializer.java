 ...
 * {@link LifetimeBaseNodeSerializer}.
 *
...
public class UuidentifyableSerializer<T extends UuidIdentifyable> extends LifetimeBaseNodeSerializer<T> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3412484854753870420L;
	...
	/**
	 * The json-serializer for the relation from a {@link UuidIdentifyable} to a
	 * {@link Library}.
	 */
	private final IterableSerializer<References> refRelationSerializer;

	/**
	 * The json-serializer for the relation from a {@link BsddNode} to a
