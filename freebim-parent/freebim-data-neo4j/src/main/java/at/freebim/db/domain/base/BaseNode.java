...
/**
 * This abstract class is the base class for nodes. It implements
 * {@link NodeIdentifyable}.
 *
...
public abstract class BaseNode implements NodeIdentifyable {
	...
	/**
	 * Holds the relations to other nodes of the same type that are considered
	 * equal.
	 *
	...
	/**
	 * Checks if two {@link Iterable} {@link BaseRel} are the same Returns true if
	 * this is the case.
	 *
	 * @return the result if the relations are equal
	 */
	protected <T extends NodeIdentifyable, R extends BaseRel<?, T>> boolean equalsRelation(final Iterable<R> self,
			final Iterable<R> other) {
