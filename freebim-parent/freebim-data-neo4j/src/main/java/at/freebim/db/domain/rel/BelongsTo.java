...
import at.freebim.db.domain.json.rel.BelongsToDeserializer;
import at.freebim.db.domain.json.rel.BelongsToSerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between the nodes or classes {@link FreebimUser} and {@link Contributor}.
 * It denotes that a {@link FreebimUser} corresponds to a {@link Contributor}.
 * The relation extends {@link BaseRel}.
 * 
