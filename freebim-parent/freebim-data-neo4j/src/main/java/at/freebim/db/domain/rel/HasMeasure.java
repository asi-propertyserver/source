...
import at.freebim.db.domain.json.rel.HasMeasureDeserializer;
import at.freebim.db.domain.json.rel.HasMeasureSerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between to nodes or classes {@link Parameter} and {@link Measure}.
 * It denotes if a {@link Parameter} has a measurement ({@link Measure}).
