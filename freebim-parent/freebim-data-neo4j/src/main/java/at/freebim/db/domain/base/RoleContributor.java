...
/**
 * Represents the role of a contributer. This class implements
...
public enum RoleContributor implements GrantedAuthority {
	 ...
	 */
	ROLE_DELETE, ROLE_VIEW_EXTENSIONS, ROLE_SET_STATUS, ROLE_SET_RELEASE_STATUS, ROLE_LIBRARY_REFERENCES;
