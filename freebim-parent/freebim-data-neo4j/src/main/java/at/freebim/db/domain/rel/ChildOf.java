...
/**
 * The node to node relation between two nodes or classes of the type {@link HierarchicalBaseNode}.
 * It denotes that one node is child of another node. This creates a hierarchy.
 * This relation extends {@link OrderedBaseRel}. and 
 * implements {@link BsddRelation}.
 * 
 * @deprecated Parent-Child-Relations are established via {@link ParentOf} relations now.
 * 
