...
import at.freebim.db.domain.json.MessageNodeDeserializer;
import at.freebim.db.domain.json.MessageNodeSerializer;
...
/**
 * The node for a message.
 * It extends {@link LifetimeBaseNode}.
 * 
...
public class MessageNode extends LifetimeBaseNode {
	 ...
	 */
	@RelatedToVia(type = RelationType.MESSAGE_SEEN, direction=Direction.OUTGOING)
	@Fetch
	 ...
	 * @return the relation to the {@link FreebimUser}s
	 */
	@RelatedToVia(type = RelationType.MESSAGE_CLOSED, direction=Direction.OUTGOING)
	@Fetch
