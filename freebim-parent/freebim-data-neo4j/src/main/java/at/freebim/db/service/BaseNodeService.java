...
/**
 * The service for a class <b>T</b> that extends {@link BaseNode}. 
 * The service extends {@link BaseService}.
 * 
...
public interface BaseNodeService<T extends BaseNode> extends BaseService<T> {
	 ...
	 * 
	 * */
	public abstract T filterBeforeInsert(T node);
	 ...
	 * 
	 * */
	public abstract T filterAfterInsert(T node);
	 ...
	 * 
	 * */
	public abstract T filterBeforeSave(T node);
	 ...
	 * 
	 * */
	public abstract T filterAfterSave(T node);
	 ...
	 * @return the filtered class/node
	 * */
	public abstract T filterResponse(T node, Long now);
	 ...
	 * 
	 * */
	public abstract T filterBeforeDelete(T node);
	 ...
	 * 
	 * */
	public abstract T filterAfterDelete(T node);
	
	/**
	 * Load all relevant node/class objects that extend {@link BaseNode}.
	 * 
	 * @return {@link ArrayList} of relevant class/node objects that extend {@link BaseNode}.  
	 * */
	public abstract ArrayList<T> getAllRelevant();
	
	/**
	 * Load all relevant node/class ids.
	 * 
	 * @return {@link ArrayList} of relevant ids of class/node objects that extend {@link BaseNode}.  
	 * */
	public abstract ArrayList<Long> getAllRelevantNodeIds();
}
