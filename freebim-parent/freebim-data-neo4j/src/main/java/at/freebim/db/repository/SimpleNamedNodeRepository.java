...
/**
 * The repository for the node/class {@link SimpleNamedNode}. It extends
 ...
 */
public interface SimpleNamedNodeRepository extends Neo4jRepository<SimpleNamedNode, Long> {
	...
	SimpleNamedNode get(String name);
