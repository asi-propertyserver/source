...
import at.freebim.db.json.rel.UnitConversionDeserializer;
import at.freebim.db.json.rel.UnitConversionSerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between nodes or classes {@link Unit}. It denotes
 * that a node {@link Unit} has been converted into another unit/node
 * ({@link Unit}). This relation extends {@link QualifiedBaseRel}.
 *
