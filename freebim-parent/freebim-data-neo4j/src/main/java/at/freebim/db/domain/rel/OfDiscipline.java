...
import at.freebim.db.domain.json.rel.OfDisciplineDeserializer;
import at.freebim.db.domain.json.rel.OfDisciplineSerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between nodes or classes {@link Parameter} and {@link Discipline}.
 * It denotes that a {@link Parameter} is connected to a {@link Discipline}.
