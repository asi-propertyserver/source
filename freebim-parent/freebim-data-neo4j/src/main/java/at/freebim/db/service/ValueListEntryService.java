 ...
 */
public interface ValueListEntryService
		extends StatedBaseNodeService<ValueListEntry>, BsddObjectService<ValueListEntry> {
	 ...
	 * @param node
	 */
	void correctNumberFormat(ValueListEntry node);
