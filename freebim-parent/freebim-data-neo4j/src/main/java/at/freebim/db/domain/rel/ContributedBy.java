...
import at.freebim.db.json.rel.ContributedByDeserializer;
import at.freebim.db.json.rel.ContributedBySerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between the nodes or classes
 * {@link ContributedBaseNode} and {@link Contributor}. It denotes that a node
 * {@link ContributedBaseNode} has been contributed by the node
 * {@link Contributor}. This relation extends {@link TimestampedBaseRel}.
 *
...
public class ContributedBy extends TimestampedBaseRel<ContributedBaseNode, Contributor> {
	...
	/**
	 * Creates a new instance of the relation with the type of the relation and the
	...
	public int hashCode() {
		...
		result = prime * result + ((contributionType == null) ? 0 : contributionType.hashCode());
		return result;
	}
