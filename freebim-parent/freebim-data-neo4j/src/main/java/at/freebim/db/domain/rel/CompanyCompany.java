...
import at.freebim.db.json.rel.CompanyCompanyDeserializer;
import at.freebim.db.json.rel.CompanyCompanySerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between two nodes or classes {@link Company}. It
