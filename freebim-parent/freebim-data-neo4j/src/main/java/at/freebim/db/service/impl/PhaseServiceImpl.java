...
/**
 * The service for the node/class {@link Phase}.
 * This service extends {@link ContributedBaseNodeServiceImpl} and
 * implements {@link PhaseService}.
 * 
...
public class PhaseServiceImpl extends ContributedBaseNodeServiceImpl<Phase> implements PhaseService {
	...
	@Override
	@Autowired
	public void setRepository(GraphRepository<Phase> r) {
		this.repository = r;
	}
	...
	public ArrayList<Phase> getAllRelevant() {
		...
		ArrayList<Phase> res = new ArrayList<Phase>();
		...
		b.append(" WHERE all(y in nodes(path) WHERE y.validFrom < {now} AND (NOT HAS(y.validTo) OR y.validTo > {now}))");
