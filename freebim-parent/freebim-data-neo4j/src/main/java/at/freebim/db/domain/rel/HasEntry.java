...
import at.freebim.db.json.rel.HasEntryDeserializer;
import at.freebim.db.json.rel.HasEntrySerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between the nodes or classes {@link ValueList} and
 * {@link ValueListEntry}. It denotes if a entry in a list ({@link ValueList})
 * has an entry ({@link ValueListEntry}). This relation extends
 * {@link OrderedBaseRel} and implements {@link BsddRelation}.
 *
