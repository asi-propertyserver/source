...
/**
 * The service for {@link Component}. This service extends {@link HierarchicalBaseNodeService} 
 * and {@link BsddObjectService}.
 * 
...
public interface ComponentService extends HierarchicalBaseNodeService<Component>, BsddObjectService<Component> {
	...
	/**
	 * Gets a {@link List} of {@link Component}s that are in the library with the provided id
	 * and have the provided name.
	 * 
