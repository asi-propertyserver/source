...
/**
 * The service for the node/class {@link SimpleNamedNode}. This service extends
...
public interface SimpleNamedNodeService extends HierarchicalBaseNodeService<SimpleNamedNode> {
	 ...
	 */
	SimpleNamedNode find(String name, String type);

	/**
	 * Find the {@link SimpleNamedNode} that has the provided name and type. If no
	 * such node is found, create a new one with the provided name and type.
	 *
	 * @param name the name of {@link SimpleNamedNode}
	 * @param type the type of {@link SimpleNamedNode}. Can be <code>null</code>.
	 * @return the {@link SimpleNamedNode} that has the provided name and type.
	 */
	SimpleNamedNode get(String name, String type);
}
