...
import at.freebim.db.json.rel.DocumentedInDeserializer;
import at.freebim.db.json.rel.DocumentedInSerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between the nodes or classes
 * {@link ContributedBaseNode} and {@link Document}. It denotes that a node
 * {@link ContributedBaseNode} has been documented in the node {@link Document}.
