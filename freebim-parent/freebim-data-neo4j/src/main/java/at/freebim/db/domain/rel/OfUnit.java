...
import at.freebim.db.domain.json.rel.OfUnitDeserializer;
import at.freebim.db.domain.json.rel.OfUnitSerializer;
import net.spectroom.neo4j.backup.annotation.RelationshipBackup;

/**
 * The node to node relation between nodes or classes {@link Measure} and {@link Unit}.
 * It denotes that a measurement ({@link Measure}) has a {@link Unit}.
 * This relation extends {@link BaseRel} an 
