...
import at.freebim.db.domain.json.rel.HasParameterDeserializer;
import at.freebim.db.domain.json.rel.HasParameterSerializer;
 ...
 * It denotes if a {@link StatedBaseNode} has a {@link Parameter}.
...
public class HasParameter extends OrderedBaseRel<StatedBaseNode, Parameter> implements BsddRelation {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((phaseUuid == null) ? 0 : phaseUuid.hashCode());
		result = prime * result
